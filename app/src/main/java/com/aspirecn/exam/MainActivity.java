...
import com.aspirecn.exam.ble.BleUtil;
import com.aspirecn.exam.ble.SportSdk;
import com.aspirecn.exam.db.AppDatabase;
...
import com.aspirecn.exam.net.MySocketClient;
import com.aspirecn.exam.net.ProtocolUtil;
import com.aspirecn.exam.net.TcpClient;
...
//        "A007e2011d0a340c5A"
    ...
    private void test() {
        ...
        try {
            Class clazz = Class.forName("com.aspirecn.exam.MyUser");
